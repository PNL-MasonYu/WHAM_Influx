...
def read_diris(IP="192.168.130.222"):
    """Run sync client."""
    ...
    msg.append("Diris_a10,sensor=hour hr={:.3f}".format(hour))
    msg.append("Diris_a10,sensor=phase_volt_12 V={:.3f}".format(phase_volt_12))
    msg.append("Diris_a10,sensor=phase_volt_23 V={:.3f}".format(phase_volt_23))
    msg.append("Diris_a10,sensor=phase_volt_31 V={:.3f}".format(phase_volt_31))
    ...
    msg.append("Diris_a10,sensor=phase_volt_1 V={:.3f}".format(phase_volt_1))
    msg.append("Diris_a10,sensor=phase_volt_2 V={:.3f}".format(phase_volt_2))
    msg.append("Diris_a10,sensor=phase_volt_3 V={:.3f}".format(phase_volt_3))
    ...
    msg.append("Diris_a10,sensor=frequency Hz={:.3f}".format(frequency))
    msg.append("Diris_a10,sensor=phase_current_1 A={:.3f}".format(phase_current_1))
    msg.append("Diris_a10,sensor=phase_current_2 A={:.3f}".format(phase_current_2))
    msg.append("Diris_a10,sensor=phase_current_3 A={:.3f}".format(phase_current_3))
    msg.append("Diris_a10,sensor=neutral_current A={:.3f}".format(neutral_current))
    ...
    msg.append("Diris_a10,sensor=active_power W={:.3f}".format(active_power))
    msg.append("Diris_a10,sensor=reactive_power W={:.3f}".format(reactive_power))
    msg.append("Diris_a10,sensor=apparent_power W={:.3f}".format(apparent_power))
    msg.append("Diris_a10,sensor=power_factor power_factor={:.3f}".format(power_factor))
    ...
    msg.append("Diris_a10,sensor=max_avg_1 current_ratio={:.3f}".format(max_avg_1))
    msg.append("Diris_a10,sensor=max_avg_2 current_ratio={:.3f}".format(max_avg_2))
    msg.append("Diris_a10,sensor=max_avg_3 current_ratio={:.3f}".format(max_avg_3))
    msg.append("Diris_a10,sensor=max_avg_n current_ratio={:.3f}".format(max_avg_n))
